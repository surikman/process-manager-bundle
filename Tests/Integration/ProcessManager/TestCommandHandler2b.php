...
use SuRiKmAn\ProcessManagerBundle\Tests\Integration\ProcessManager\TestCommand2b as TestCommand;

/**
 *
 */
final class TestCommandHandler2b implements CommandHandlerInterface
{
    /**
