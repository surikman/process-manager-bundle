...
use SuRiKmAn\ProcessManagerBundle\Tests\Integration\ProcessManager\TestCommand4 as TestCommand;

/**
 *
 */
final class TestCommandHandler4 implements CommandHandlerInterface
{
    /**
...
//        $this->eventStorage->addEvent(new TestEvent3());
        $this->eventStorage->addEvent(new TestEvent5());
    }
}
